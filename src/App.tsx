      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="flex items-center gap-2">
          {config.logo?.src ? (
            ...
            <span className="font-serif text-2xl tracking-widest uppercase font-light">{config.business.name}</span>
          )}
        </div>
    ...
    <section className="relative h-screen w-full overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute bottom-12 left-6 md:left-12 z-10 hidden md:block">
        <div className="flex items-center gap-4 text-white/60 text-[10px] uppercase tracking-widest">
          <div className="flex items-center gap-2">
            <ShieldCheck size={14} className="text-primary" aria-hidden="true" /> Medizinische Kosmetik
          </div>
